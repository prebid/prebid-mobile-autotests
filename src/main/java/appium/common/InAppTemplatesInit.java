...
//        put(NATIVE_AD_IN_APP, REQUEST_TEMPLATE_NATIVE);
        ...
        put(NATIVE_AD_MO_PUB_MP,REQUEST_TEMPLATE_NATIVE);
        put(NATIVE_AD_MO_PUB,REQUEST_TEMPLATE_NATIVE);
        put(NATIVE_AD_MO_PUB_PBM,REQUEST_TEMPLATE_NATIVE);
        put(NATIVE_AD_FEED_MO_PUB,REQUEST_TEMPLATE_NATIVE);
    ...
    private final static HashMap<String, String> responseTemplates = new HashMap<>() {{
        ...
        put(NATIVE_AD_MO_PUB_MP,RESPONSE_TEMPLATE_NATIVE);
        put(NATIVE_AD_MO_PUB,RESPONSE_TEMPLATE_NATIVE);
        put(NATIVE_AD_MO_PUB_PBM,RESPONSE_TEMPLATE_NATIVE);
