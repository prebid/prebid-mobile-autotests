...
public class InAppTemplatesInit implements InAppAdNamesImpl {
    ...
    private final static String RESPONSE_TEMPLATE_AD_CONFIGURATION = "appium/inAppBidding_responses/%s/inApp_video_320x480_with_ad_configuration.json";
    ...
    private final static HashMap<String, String> responseTemplates = new HashMap<>() {{
        ...
        put(VIDEO_INTERSTITIAL_320x480_IN_APP_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_INTERSTITIAL_320x480_GAM_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_INTERSTITIAL_320x480_ADMOB_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_INTERSTITIAL_320x480_MAX_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);

        put(VIDEO_REWARDED_320x480_IN_APP_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_REWARDED_320x480_GAM_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_REWARDED_320x480_ADMOB_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
        put(VIDEO_REWARDED_320x480_MAX_WITH_AD_CONFIGURATION,RESPONSE_TEMPLATE_AD_CONFIGURATION);
    }};
}
