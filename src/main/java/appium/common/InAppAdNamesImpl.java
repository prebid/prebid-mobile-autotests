...
public interface InAppAdNamesImpl {
    ...
    String BANNER_SKADNETWORK = "Banner 320x50 (In-App) [SKAdN 2.2]";
    ...
    String BANNER_320x50_GAM_ORIGINAL_NO_SKADN = "Banner 320x50 (GAM Original) [NO SKAdN 2.2]";
...
//    String BANNER_ADAPTIVE_MAX = "Banner Adaptive (MAX)";
    ...
    String INTERSTITIAL_320x480_IN_APP_SKADN = "Display Interstitial 320x480 (In-App) [SKAdN 2.2]";
    String INTERSTITIAL_320x480_IN_APP_NO_SKADN = "Display Interstitial 320x480 (In-App) [NO SKAdN 2.2]";
...
//    String INTERSTITIAL_320x480_NO_BID_MAX = "Display Interstitial 320x480 (MAX) [noBids, No Ad]";
    ...
    String VIDEO_INTERSTITIAL_320x480_IN_APP_SKADN = "Video Interstitial 320x480 (In-App) [SKAdN 2.2]";
...
//    String VIDEO_INTERSTITIAL_320x480_NO_BID_MAX = "Video Interstitial 320x480 (MAX) [noBids, No Ad]";
    ...
    String VIDEO_OUTSTREAM_IN_APP_SKADN = "Video Outstream (In-App) [SKAdN 2.2]";
    ...
    String VIDEO_REWARDED_320x480_IN_APP_SKADN = "Video Rewarded 320x480 (In-App) [SKAdN 2.2]";
