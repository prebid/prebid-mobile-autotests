...
public class GamDelegatesCheck implements DelegatesCheck {
    private InAppBiddingHomePageImpl homePage;
    private InAppBiddingAdPageImpl adPage;

    public GamDelegatesCheck(InAppBiddingHomePageImpl homePage, InAppBiddingAdPageImpl adPage) {
        this.homePage = homePage;
        this.adPage = adPage;
    }

    public GamDelegatesCheck(InAppBiddingHomePageImpl homePage) {
        this.homePage = homePage;
    }
